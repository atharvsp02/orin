...
import { ChevronLeft, ChevronRight, Plus, ArrowRight, MessageSquare, GitBranch, Terminal, Puzzle, ThumbsUp } from "lucide-react"
  ...
  return (
    <div className="flex flex-col gap-3 p-4">
      ...
      <p className="text-sm text-zinc-300">
        /why did we reject <span className="text-zinc-500">redis?</span>
      </p>
      ...
      <div className="mt-2 flex items-center gap-2 bg-zinc-800/50 rounded-lg px-3 py-2">
        ...
        <span className="text-sm text-zinc-300">Orin</span>
        <span className="text-xs text-zinc-500">cited answer</span>
      </div>
  ...
  return (
    <div className="flex flex-col gap-2 p-4">
      <div className="flex items-center gap-2 text-xs">
        ...
        <span className="text-zinc-400">PR-214</span>
        <span className="text-zinc-500">add-redis-cache</span>
        <span className="text-blue-400/70">check failed</span>
      </div>
      ...
      <div className="mt-3 space-y-2">
        <div className="flex items-center gap-2 text-xs">
          ...
          <span className="text-zinc-600">flagged</span>
          <span className="text-blue-400/70">ISSUE-42</span>
          <span className="text-zinc-600">re-propos...</span>
        </div>
        <div className="flex items-center gap-2 text-xs">
          <span className="text-zinc-600">↗</span>
          <span className="text-zinc-500">orin</span>
          <span className="text-zinc-600">posted citation with evidence...</span>
        </div>
        <div className="flex items-center gap-2 text-xs">
          <span className="text-zinc-600">↗</span>
        ...
        <div className="flex items-center gap-2 text-xs">
          <span className="text-zinc-600">↗</span>
          <span className="text-zinc-500">orin</span>
          <span className="text-zinc-600">reweighted decision graph...</span>
        </div>
      </div>
    </div>
  )
    ...
    <div className="flex items-center justify-center h-full">
      <div className="relative w-32 h-56 bg-zinc-900 rounded-2xl border border-zinc-700 overflow-hidden">
        ...
        <div className="mt-6 px-3">
          <div className="text-[10px] text-zinc-400 mb-2">Triage</div>
  ...
  return (
    <div className="flex items-center justify-center h-full">
      <div className="w-24 h-24 rounded-2xl bg-zinc-800 flex items-center justify-center">
        <Terminal className="w-12 h-12 text-zinc-400" strokeWidth={2.5} />
      </div>
    </div>
  )
}
  ...
  return (
    <div className="flex items-center justify-center h-full">
      <div className="relative">
        <ThumbsUp className="w-16 h-16 text-zinc-400" />
      </div>
    </div>
  )
}
  ...
  return (
    <div className="flex items-center justify-center h-full">
      <div className="bg-zinc-800/50 rounded-lg px-4 py-2 border border-zinc-700/50">
        <span className="text-xs font-mono text-zinc-400">ORIN API</span>
      </div>
    </div>
  )
}
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 mb-16">
          ...
          <p className="text-zinc-400 lg:max-w-sm lg:pt-12">
            One memory, every surface. Orin answers where your team already works, and every install provisions its
            own isolated tenant.
          </p>
        </div>
