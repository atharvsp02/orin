...
function ConnectHub({ me }: { me: Me }) {
  ...
  const cards = [
    ...
    },
    {
      Icon: SiLinear,
      name: "Linear",
      what: "Search Linear issues and comments with the same team and shared-issue permissions people have in Linear.",
      how: "Authorize Orin for your Linear organization. It creates isolated workspace memory and starts permission-aware sync.",
